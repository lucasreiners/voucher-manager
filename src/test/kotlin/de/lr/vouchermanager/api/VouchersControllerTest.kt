...
class VouchersControllerTest {
    ...
    @Test
    fun `should return empty list when no vouchers exist`(): Unit =
        runBlocking {
            // Act
    ...
    @Test
    fun `should return list of vouchers when vouchers exist`(): Unit =
        runBlocking {
            // Arrange
    ...
    @Test
    fun `should create new voucher`(): Unit =
        runBlocking {
            // Arrange
            val request =
    ...
    @Test
    fun `should redeem voucher`(): Unit =
        runBlocking {
            // Arrange
            val voucherId = UUID.randomUUID()
            transaction {
    ...
    @Test
    fun `should not redeem already redeemed voucher`(): Unit =
        runBlocking {
            // Arrange
            val voucherId = UUID.randomUUID()
